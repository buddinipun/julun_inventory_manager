...
<div class="wrap p-t-0">
    <footer class="app-footer">
        <div class="clearfix">
            ...
            <div class="copyright pull-left">Copyright @APTOTA - WEB SOLUTIONS -  2018 &copy;</div>
        </div>
    </footer>
</div>
<!-- /#app-footer -->
...
<script type="text/javascript" src="public/static/libs/bower/jQuery-Storage-API/jquery.storageapi.min.js"></script>

<!-- <spring:url value="/resources/libs/bower/bootstrap-sass/assets/javascripts/bootstrap.js" var="bootstrapJS"/> -->
<script type="text/javascript" src="public/static/libs/bower/bootstrap-sass/assets/javascripts/bootstrap.js"></script>

<!-- <spring:url value="/resources/libs/bower/jquery-slimscroll/jquery.slimscroll.js" var="jquerySlimscroll"/> -->
<script type="text/javascript" src="public/static/libs/bower/jquery-slimscroll/jquery.slimscroll.js"></script>

<!-- <spring:url value="/resources/libs/bower/perfect-scrollbar/js/perfect-scrollbar.jquery.js" var="perfectScrollbar"/> -->
<script type="text/javascript" src="public/static/libs/bower/perfect-scrollbar/js/perfect-scrollbar.jquery.js"></script>

<!-- <spring:url value="/resources/libs/bower/PACE/pace.min.js" var="paceMin"/> -->
<script type="text/javascript" src="public/static/libs/bower/PACE/pace.min.js"></script>

<!-- <spring:url value="/resources/assets/js/library.js" var="libraryJS"/> -->
<script type="text/javascript" src="public/static/js/library.js"></script>
...
<script type="text/javascript" src="public/static/libs/bower/moment/moment.js"></script>

<!-- <spring:url value="/resources/libs/bower/fullcalendar/dist/fullcalendar.min.js" var="fullcalendarJS"/> -->
<script type="text/javascript" src="public/static/libs/bower/fullcalendar/dist/fullcalendar.min.js"></script>
