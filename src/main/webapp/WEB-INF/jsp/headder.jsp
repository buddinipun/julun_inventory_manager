     ...
     <div class="menubar-scroll">
        <div class="menubar-scroll-inner">
            <ul class="app-menu">
                ...
                <security:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_CASHIER')">
               ...
               <security:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_USER')">
                <li class="has-submenu">
                   ...
                   <ul class="submenu">
                     <li><a href="<%=request.getContextPath()%>/orders/order/create">Place order</a></li>
                      <li><a href="<%=request.getContextPath()%>/orders/order/view">View order</a></li>
                   </ul>
                 </li>
                </security:authorize>
                ...
                <li class="has-submenu">
                    <a href="javascript:void(0)" class="submenu-toggle">
                        ...
                        <span class="menu-text">Sales Person Mgt</span>
                        <i class="menu-caret zmdi zmdi-hc-sm zmdi-chevron-right"></i>
                    </a>
                    <ul class="submenu">
                        <li><a href="<%=request.getContextPath()%>/users/salesAgent/create">Create Sales Person</a></li>
                        <li><a href="<%=request.getContextPath()%>/users/salesAgent/edit">Edit Sales Person</a></li>
                   </ul>
               </li>
