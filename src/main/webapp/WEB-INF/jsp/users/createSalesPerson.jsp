                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Register Sales Person</h3>
                        </div>
                        <div class="panel-body">
                            <form:form role="form" class="form-horizontal" action="user.reg" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-md-2 control-label">Mobile Number <span
                                        ...
                                        <div class="col-md-3" class="form-horizontal">
                                            <form:input type="text" class="validate[required,maxSize[3]] form-control"
                                                        path="contactNo" id="Mobile_number" placeholder="Enter Mobile Number..."/>
                                            <span style="color: red"><label id="lbl_mobile_numb"></label></span></span>
                                        </div>
                                    </spring:bind>
                            ...
                            <div class="table-responsive">
                                <table id="default-datatable" data-plugin="DataTable" class="table table-striped" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                   <c:forEach items="${salesUsers}" var="salesUsers">
                                        <tr>

                                            <td>${salesUsers.fname}</td>
                                            <td>${salesUsers.lname}</td>
                                            <td>${salesUsers.username}</td>
                                            <td>${salesUsers.contact}</td>
...
<%@include file="../include/footer.jsp" %>
    ...
    <script !src="">
        ...
        function validateForm() {
            ...
            var contactNo = $('#Mobile_number').val().trim();
            ...
            document.getElementById("user_fname").focus();
                ...
                $("#error").html("Please fill Agent Contact Number required fields!");
                $('#myModal').modal("show");
                document.getElementById("contactNo").focus();


                } else {
                    alert("sucesss validate");
                  $("#userreg_form").submit();
